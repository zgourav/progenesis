    ...
    >
      ...
      <div className="section-spacing px-4 sm:px-6 md:px-10 lg:px-14 xl:px-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 items-stretch">
          {/* Left: Form Card */}
          <div className="w-full overflow-visible break-words bg-white/95 backdrop-blur rounded-2xl md:rounded-[18px] p-5 sm:p-6 md:p-7 lg:p-8 shadow-[0_8px_24px_rgba(0,0,0,0.12)] border border-black/5" style={{padding:'16px'}}>
            <div className="text-center mb-3" style={{paddingBottom:'16px'}}>
              <span className="text-[11px] sm:text-[12px] px-3 py-1 rounded-[8px] border-[#1656A5]/30 text-[#1656A5] bg-[#1656A5]/5"style={{padding:'4px'}}>
            ...
            <form className="mt-5 space-y-3 gap-3 border-[#D9D9D9] " style={{paddingTop:'16px'}}>
              <div className="border border-[#D9D9D9] rounded-2xl p-3 sm:p-4 md:p-5 overflow-visible mb-4 mr-4" style={{padding:'16px', margin:''}}>
              <input
                type="text"
                placeholder="Full Name"
                style={{padding:'8px' , margin:'8px'}} className="w-full rounded-[16px] border border-[#D9D9D9] bg-white h-11 px-4 text-sm outline-none focus:ring-2 focus:ring-[#1656A5]/20 focus:border-[#1656A5]/40"
              />
              <input
                type="email"
              ...
              <div className="relative">
                <input
                  ...
                  style={{padding:'8px' , margin:'8px'}} className="w-full rounded-[16px] border border-[#D9D9D9] bg-white h-11 px-4 pr-10 text-sm outline-none focus:ring-2 focus:ring-[#1656A5]/20 focus:border-[#1656A5]/40 [color-scheme:light]"
                />
              ...
              />
              <div className="relative">
                <select style={{padding:'8px' , margin:'8px'}}
                  className="appearance-none w-full rounded-[16px] border border-[#D9D9D9] bg-white h-11 px-4 pr-9 text-sm outline-none focus:ring-2 focus:ring-[#1656A5]/20 focus:border-[#1656A5]/40"
                  defaultValue=""
                >
              ...
              <label style={{padding:'8px' , margin:'8px'}} className="flex items-start gap-2 text-[12px] text-gray-600 select-none">
              ...
              <div className="pt-1 justify-center items-center text-center" style={{padding:'8px' , margin:'8px'}}>
                <button
                  type="button"
                  style={{padding:'8px'}}
                  className="inline-flex items-center justify-center rounded-[16px] bg-[#1656A5] text-white text-sm font-medium h-10 px-5 shadow hover:shadow-md transition-shadow"
                >
                  Book Appointment
                </button>
              </div>
